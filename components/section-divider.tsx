  ...
  return (
    <motion.div
      ...
      className="
        ...
        bg-gradient-to-t 
        from-[var(--color-PrimaryBg)] 
        via-[var(--color-AccentHover)] 
        to-[var(--color-Accent)]
        dark:from-[var(--color-dark-PrimaryBg)]
        dark:via-[var(--color-dark-AccentHover)]
        dark:to-[var(--color-dark-Accent)]
        ...
        dark:before:via-[var(--color-dark-Accent)]
