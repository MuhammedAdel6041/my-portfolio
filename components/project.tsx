...
export default function Project({
        ...
        >
            ...
            <div className="relative flex-shrink-0 w-full sm:w-[50%] flex justify-center items-center">
                <motion.div
                    ...
                    className="
            relative w-full h-[230px] sm:h-[300px] rounded-2xl overflow-hidden shadow-2xl 
  ...
  "
    ...
    "
                ...
                <ul className="flex flex-wrap gap-2 mb-6">
                    {tags.map((tag, index) => (
                        <li
                            key={index}
                            className="
                px-3 py-1 text-[0.75rem] bg-white/10 rounded-full uppercase 
                tracking-wide text-[var(--color-SecondaryText)]
              "
                        >
                            {tag}
                        </li>
      ...
      hover:bg-[var(--color-AccentMuted)] hover:text-white 
