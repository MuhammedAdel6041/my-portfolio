...
export default function About() {
  ...
  return (
    ...
    >
      {/* Background glow */}
      <div className="absolute -z-10 inset-0 bg-[radial-gradient(circle_at_center,rgba(78,245,200,0.1),transparent_60%)] blur-3xl" />
      ...
      >
        ...
        <motion.div
          ...
          className="
            ...
            shadow-[0_0_40px_rgba(78,245,200,0.4)]
            flex-shrink-0
          "
        >
          <Image
        ...
        <motion.div
          ...
          className="
            ...
            bg-gradient-to-br from-[#0E1419] to-[#121A1F] 
            border border-[var(--color-Border)] rounded-xl 
            shadow-[0_0_40px_rgba(78,245,200,0.15)] overflow-hidden
          "
        >
          {/* Window header */}
          <div className="flex items-center gap-2 px-4 py-2 border-b border-[var(--color-Border)] bg-[#151A1F]">
          ...
          <div
            className="
              p-4 sm:p-5 md:p-6 
              font-mono text-[var(--color-SecondaryText)] 
